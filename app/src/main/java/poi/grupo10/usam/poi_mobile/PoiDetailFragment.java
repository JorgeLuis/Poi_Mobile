package poi.grupo10.usam.poi_mobile;
...
import poi.grupo10.usam.poi_mobile.dummy.DummyContent;
...
public class PoiDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.poi_detail)).setText(mItem.details);
        }
